...
tf.app.flags.DEFINE_string('checkpoint_dir','inception_finetuned_models/birds_valid299/model.ckpt',
                           """Path where to read model checkpoints.""")

tf.app.flags.DEFINE_string('image_folder', 'val_gen_images/valid/single',
